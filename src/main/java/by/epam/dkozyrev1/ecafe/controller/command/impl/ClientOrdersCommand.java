...
public class ClientOrdersCommand extends Command {
    ...
    public ClientOrdersCommand(ServletRequest request, ServletResponse response){
    ...
    public void executeGet() throws ControllerException {
        try {
            getRequest().getRequestDispatcher("/WEB-INF/jsp/orders.jsp").forward(getRequest(), getResponse());
